...
static void Animate(void)
{
    ...
    // Draw a sun	-- as a yellow, wireframe sphere
  ...
  // Draw another planet
	...
	// Third, draw the planet as a wireframe sphere.
    ...
    glPushMatrix();						// Save matrix state
	// Draw the moon of the planet.
	//	Use DayOfYear to control its rotation around the  the planet
   	glRotatef( 15, 0.0, 0.0, 1.0 );
   	glRotatef( (-360.0)*6.0*DayOfYear/365.0, 0.0, 1.0, 0.0 );
	...
	// Draw the moon of the planet.
	//	Use DayOfYear to control its rotation around the  the planet
   	glRotatef( (-360.0)*3.0*DayOfYear/365.0, 0.0, 1.0, 0.0 );
